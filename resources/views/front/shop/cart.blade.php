                ...
                <div class="cart-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="price first-row">${{ number_format($cart->price,2) }}</td>
                            ...
                            <td class="total-price fisrt-row">${{number_format($cart->price * $cart->qty,2)}}</td>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="discount-coupon">
                            ...
                            <form action="#" class="coupon-form"> <input type="text"
                                                                         placeholder="Enter your Codes Here">
